...
class ReferralStats(models.Model):
    ...
    total_rewards = models.DecimalField(default=0.00, max_digits=10, decimal_places=2, verbose_name=_("Total Rewards"))
    average_conversion_value = models.DecimalField(default=0.00, max_digits=10, decimal_places=2, verbose_name=_("Average Conversione Value"))
    highest_referral_earning = models.DecimalField(default=0.00, max_digits=10, decimal_places=2, verbose_name=_("Highest Referral Earning"))

    def __str__(self):
        return f"ReferralStats for {self.referral_code.code} in {self.period}"
