...
class ReferralConversion(models.Model):
    ...
    conversion_date = models.DateField(auto_now_add=True, verbose_name=_("Conversion Date"))
    conversion_value = models.DecimalField(default=0.00, max_digits=10, decimal_places=2, verbose_name=_("Conversion Value"))
    ...
    def __str__(self):
        return f"ReferralConversion {self.id}"
