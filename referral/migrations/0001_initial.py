    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Active', 'Active'), ('Expired', 'Expired'), ('Used', 'Used')], max_length=50, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_audit_referral_code', to='referral.referralcode', verbose_name='Referral Codes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Completed', 'Completed'), ('Pending', 'Pending'), ('Failed', 'Failed')], max_length=50, verbose_name='Status')),
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_conversion_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
                ('referred_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referral_conversion_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_engagement_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('Bonus', 'Bonus'), ('Alert', 'Alert'), ('Reminder', 'Reminder')], max_length=50, verbose_name='Notification Type')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='engagement_notification_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward_type', models.CharField(choices=[('Cash', 'Cash'), ('Discount', 'Discount'), ('Points', 'Points')], max_length=50, verbose_name='Reward Type')),
        ...
        migrations.AddField(
            ...
            name='program',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_code_program', to='referral.referralprogram', verbose_name='Program'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_campaign_program', to='referral.referralprogram', verbose_name='Program')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bonus_type', models.CharField(choices=[('Cash', 'Cash'), ('Discount', 'Discount'), ('Points', 'Points')], max_length=50, verbose_name='Bonus Type')),
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_bonus_program', to='referral.referralprogram', verbose_name='Program')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referred', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referrals_received', to=settings.AUTH_USER_MODEL, verbose_name='Referred')),
                ...
                ('program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referrals', to='referral.referralprogram', verbose_name='Program')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='engagement_program_partecipation_program', to='referral.referralprogram', verbose_name='Program')),
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='engagement_program_partecipation_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referra_reward_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referra_reward_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referra_setting_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referra_stats_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referra_transaction_referral_code', to='referral.referralcode', verbose_name='Referral Code')),
                ('referred_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referra_transaction_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_rewards_earned', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Total Rewards Earned')),
                ('total_spent_by_referred_users', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Total Spent By Referred Users')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referra_user_user', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
