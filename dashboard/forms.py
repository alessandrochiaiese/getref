...
from .models import Profile, ProfileBusiness, Sector, Region
...
class EnterpriseForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'chamber_commerce_certificate': forms.ClearableFileInput(attrs={'class': 'form-control'}),
            'insurance_policy_certificate': forms.ClearableFileInput(attrs={'class': 'form-control'}),
