...
from dashboard.models import ReferralProgramPartecipation  # Importiamo il modello ReferralProgramPartecipation
from dashboard.forms import ReferralProgramPartecipationForm
